    ...
    const projects = [
        {
            ...
            description: 'Vartalaap is a video calling app like Google meet which provides real-time video calling service as well as real-time captions for users',
            tech: ['NextJS', 'Django', 'WebRTC', 'WebSocket', 'React', 'TypeScript', 'Python', 'PostgreSQL']
        },
        {
            title: 'Quiz App',
            description: 'Quiz app is a web application which provides a platform to create and play quizzes',
            tech: ['NextJS', 'Django', 'React', 'TypeScript', 'Python', 'MongoDB']
        },
    ];
