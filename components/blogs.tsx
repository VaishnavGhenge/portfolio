                            ...
                            <div className='group relative transition-all lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
                                ...
                                <div className='z-10 relative'>
                                    <div className='flex gap-3 sm:gap-4 items-start'>
                                        {article.cover_image && (
                                            <div className='flex-shrink-0 w-20 h-20 sm:w-32 sm:h-20 md:w-40 md:h-24 relative rounded overflow-hidden'>
                                                <Image
                                        ...
                                        <div className='flex-1 min-w-0'>
                                            <a
                                                href={article.url}
                                                className='text-base sm:text-lg leading-snug font-medium hover:text-white hover:underline'
                                                target="_blank"
