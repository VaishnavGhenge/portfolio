    ...
    return (
        <div className='mb-16'>
            ...
            <div>
                ...
                <p className='mt-4'>I am passionate about creating efficient, user-centric applications and continuously expanding my technical expertise. My experience spans real-time communication systems using WebRTC and WebSockets, backend development with Django and Flask, and modern frontend frameworks including React and Next.js.</p>
                <p className='mt-4'>Beyond professional development, I maintain a balanced lifestyle through cricket and connecting with peers in the tech community.</p>
            </div>
        </div>
    )
}
